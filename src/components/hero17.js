            ...
            {props.heading1 ?? (
              <Fragment>
                <span className="hero17-text6">
                  Rutas del Arte: Explorando el Centro León y los Museos del
                  Cibao Central
                </span>
              </Fragment>
            )}
            ...
            {props.content1 ?? (
              <Fragment>
                <span className="hero17-text8">
                  ...
                  Informática del COPPHU. En este espacio, exploraremos juntos
                  la riqueza cultural y artística del Centro León y otros museos
                  del Cibao Central. Acompáñanos en este viaje de descubrimiento
                  y aprendizaje.
                </span>
              </Fragment>
            )}
        ...
        <div className="hero17-actions">
          <button className="thq-button-filled hero17-button1">
            <span className="thq-body-small">
              {props.action1 ?? (
                <Fragment>
                  <span className="hero17-text5">Explora más</span>
                </Fragment>
              )}
            </span>
          </button>
