        ...
        <div data-thq="thq-navbar-nav" className="navbar8-desktop-menu">
          <nav className="navbar8-links1">
            ...
            >
              {props.link1 ?? (
                <Fragment>
                  <span className="navbar8-text14">index.html</span>
                </Fragment>
              )}
            </a>
            <a href={props.link2Url} className="thq-link thq-body-small">
              {props.link2 ?? (
                <Fragment>
                  <span className="navbar8-text23">explorar.html</span>
                </Fragment>
              )}
            </a>
            <a
            ...
            >
              {props.link3 ?? (
                <Fragment>
                  <span className="navbar8-text21">actividades.html</span>
                </Fragment>
              )}
            </a>
            <div
            ...
            >
              <span className="thq-link thq-body-small">
                {props.link4 ?? (
                  <Fragment>
                    <span className="navbar8-text15">contacto.html</span>
                  </Fragment>
                )}
              </span>
          ...
          <div className="navbar8-buttons1">
            <button className="navbar8-action11 thq-button-animated thq-button-filled">
              <span>
                {props.action1 ?? (
                  <Fragment>
                    <span className="navbar8-text25">Acción 1</span>
                  </Fragment>
                )}
              </span>
            </button>
            <button className="navbar8-action21 thq-button-animated thq-button-outline">
              <span>
                {props.action2 ?? (
                  <Fragment>
                    <span className="navbar8-text26">Acción 2</span>
                  </Fragment>
                )}
              </span>
            </button>
                      ...
                      <div className="navbar8-menu-item1">
                        ...
                        <div className="navbar8-content1">
                          <span className="navbar8-page11 thq-body-large">
                            {props.page1 ?? (
                              <Fragment>
                                <span className="navbar8-text16">Inicio</span>
                              </Fragment>
                            )}
                          </span>
                            ...
                            {props.page1Description ?? (
                              <Fragment>
                                <span className="navbar8-text20">
                                  Bienvenidos al blog &apos;Rutas del Arte:
                                  Explorando el Centro León y los Museos del
                                  Cibao Central&apos;. Aquí podrás descubrir la
                                  riqueza cultural de esta región a través de
                      ...
                      <div className="navbar8-menu-item2">
                        ...
                        <div className="navbar8-content2">
                          <span className="navbar8-page21 thq-body-large">
                            {props.page2 ?? (
                              <Fragment>
                                <span className="navbar8-text18">Explorar</span>
                              </Fragment>
                            )}
                          </span>
                          <span className="thq-body-small">
                            {props.page2Description ?? (
                              <Fragment>
                                <span className="navbar8-text19">
                                  Descubre más sobre los lugares emblemáticos
                                  del arte en el Centro León y otros museos del
                                  Cibao Central.
                                </span>
                              </Fragment>
                            )}
                            ...
                            {props.page3Description ?? (
                              <Fragment>
                                <span className="navbar8-text24">
                                  Participa en nuestras actividades educativas y
                                  culturales para enriquecer tu experiencia
                                  artística.
                                </span>
                              </Fragment>
                            )}
                      ...
                      <div className="navbar8-menu-item4">
                        ...
                        <div className="navbar8-content4">
                          <span className="navbar8-page41 thq-body-large">
                            {props.page4 ?? (
                              <Fragment>
                                <span className="navbar8-text17">Contacto</span>
                              </Fragment>
                            )}
                          </span>
                          <span className="thq-body-small">
                  ...
                  <div className="navbar8-content5">
                    ...
                    <span className="thq-body-small">
                      {props.page1Description ?? (
                        <Fragment>
                          <span className="navbar8-text20">
                            Bienvenidos al blog &apos;Rutas del Arte: Explorando
                            el Centro León y los Museos del Cibao Central&apos;.
                            Aquí podrás descubrir la riqueza cultural de esta
                            región a través de nuestras publicaciones.
                          </span>
                        </Fragment>
                      )}
                    </span>
                  ...
                  <div className="navbar8-content6">
                    ...
                    <span className="thq-body-small">
                      {props.page2Description ?? (
                        <Fragment>
                          <span className="navbar8-text19">
                            Descubre más sobre los lugares emblemáticos del arte
                            en el Centro León y otros museos del Cibao Central.
                          </span>
                        </Fragment>
                      )}
                    </span>
                ...
                <div className="navbar8-menu-item7">
                  ...
                  <div className="navbar8-content7">
                    <span className="navbar8-page32 thq-body-large">
                      {props.page3 ?? (
                        <Fragment>
                          <span className="navbar8-text27">Actividades</span>
                        </Fragment>
                      )}
                    </span>
                    <span className="thq-body-small">
                      {props.page3Description ?? (
                        <Fragment>
                          <span className="navbar8-text24">
                            Participa en nuestras actividades educativas y
                            culturales para enriquecer tu experiencia artística.
                          </span>
                        </Fragment>
                      )}
                    </span>
...
Navbar8.defaultProps = {
  ...
  page1ImageAlt: 'Imagen de Inicio',
  page2: undefined,
  logoSrc:
    'https://aheioqhobo.cloudimg.io/v7/_playground-bucket-v2.teleporthq.io_/84ec08e8-34e9-42c7-9445-d2806d156403/fac575ac-7a41-484f-b7ac-875042de11f8?org_if_sml=1&force_format=original',
  page2ImageAlt: 'Imagen de Explorar',
  page1ImageSrc:
  ...
  page3ImageAlt: 'Imagen de Actividades',
  link3Url: 'https://www.teleporthq.io',
  page4ImageAlt: 'Imagen de Contacto',
  ...
  page3: undefined,
  logoAlt: "Logo del Blog 'Rutas del Arte'",
}
