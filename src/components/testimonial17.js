            ...
            {props.content1 ?? (
              <Fragment>
                <span className="testimonial17-text33">
                  Visitar el Centro León y los museos del Cibao Central ha sido
                  una experiencia enriquecedora que me ha permitido conocer más
                  ...
                  {props.review1 ?? (
                    <Fragment>
                      <span className="testimonial17-text30">
                        ¡Recomiendo totalmente esta experiencia a todos los
                        amantes del arte y la historia! Es una oportunidad única
                  ...
                  {props.review2 ?? (
                    <Fragment>
                      <span className="testimonial17-text28">
                        Explorar los museos del Cibao Central me ha inspirado a
                        seguir aprendiendo sobre nuestro patrimonio cultural.
                  ...
                  {props.review3 ?? (
                    <Fragment>
                      <span className="testimonial17-text31">
                        El arte y la historia se unen en cada rincón de estos
                        museos. ¡Una experiencia educativa que todos deberían
                  ...
                  {props.review4 ?? (
                    <Fragment>
                      <span className="testimonial17-text37">
                        Descubrir el Centro León y los museos del Cibao Central
                        ha despertado mi curiosidad por la cultura dominicana.
                        ¡Una visita obligada para todos!
                      </span>
                    </Fragment>
                  )}
                </span>
...
Testimonial17.defaultProps = {
  ...
  heading1: undefined,
  author2Alt: 'Image of Carlos Fernandez',
  ...
  review1: undefined,
  author1Alt: 'Image of Sofia Ramirez',
  review3: undefined,
  ...
  author3Alt: 'Image of Luisa Martinez',
  review4: undefined,
  author4Alt: 'Image of Javier Lopez',
  author1Src:
